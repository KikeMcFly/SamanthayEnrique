...
//         var minOpacity = 0.01; // Opacidad mínima
//         var maxOpacity = 0.07; // Opacidad máxima
//         var rotationSpeed = 0.02; // Velocidad de rotación
//         var maxRotation = Math.PI / 0.3; // Máxima rotación (en radianes)
//         var minSize = 15; // Tamaño mínimo de las partículas
//         var maxSize = 60; // Tamaño máximo de las partículas
//         var svgImage = new Image();
//         svgImage.src = "ARCHIVOS/FLOWER.svg"; // Cambia la ruta por la de tu imagen SVG
...
//             ctx.drawImage(svgImage, -this.size / 2, -this.size / 2, this.size, this.size); // Dibujar imagen SVG con tamaño
//             ctx.restore();
//             ctx.globalAlpha = 1;
//         }
...
var canvas = document.getElementById("canvas");
        ...
        var blurIntensity = 5; // Intensidad del desenfoque (en píxeles)
